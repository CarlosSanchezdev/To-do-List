    ...
    <>
      <ul className="list w-5/6 md:w-3/5 lg:w-2/5">
        ...
        allNotes != null &&
          ...
          allNotes.map((item) =>
            <Item isOpen={isOpen} setIsOpen={setIsOpen} item={item} setNoteEdit={setNoteEdit}/>
          )
      ...
      {isOpen &&
      <Edit isOpen={isOpen} setIsOpen={setIsOpen} allNotes={allNotes} setNotes={setNotes} noteEdit={noteEdit}/>
      }
    </>
